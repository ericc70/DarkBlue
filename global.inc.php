...
:root {
	...
	--colortextbacktab: #<?php print $colortext; ?>;
	--colorboxiconbg: #eee;
	--refidnocolor:#444;
...
input[type=file ]    { background-color: transparent; border-top: none; border-left: none; border-right: none; }
...
div.tabBarWithBottom {
	padding-bottom: 18px;
	border-bottom: 1px solid var(--colorbacktitle1 );
}
